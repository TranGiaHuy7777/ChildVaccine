            ...
            <div class="payment-wrapper">
                ...
                <div class="payment-summary">
                    ...
                    <div class="info-group">
                        ...
                        <div class="price"><%= vaccinePrice%></div>
                    </div>
                    <form id="paymentForm" action="MainController" method="POST">
                        <input type="hidden" name="action" value="processPayment">
                        <input type="hidden" name="appointmentID" value="${sessionScope.latestAppointment.appointmentID}">
                        <input type="hidden" name="amount" value="${sessionScope.selectedVaccine.price}">

                        <div class="payment-methods">
                            <div class="payment-method-card" data-value="momo">
                                <i class="payment-icon fas fa-wallet"></i>
                                <div>MoMo</div>
                            </div>
                            <div class="payment-method-card" data-value="vnpay">
