...
<html>
    <head>
        ...
        <style>
            * {
            ...
            /* Thêm style cho phần divider và register section */
            .divider {
                text-align: center;
                margin: 30px 0;
                position: relative;
    ...
    <body>
        ...
        <%
            ...
            String savedStaffUsername = "";
            String savedStaffPassword = "";
            ...
            if (cookies != null) {
                for (Cookie cookie : cookies) {
                    switch (cookie.getName()) {
                        ...
                        case "staff_username":
                            savedStaffUsername = cookie.getValue();
                            break;
                        case "staff_password":
                            savedStaffPassword = cookie.getValue();
                            break;
                    }
                }
            }
        ...
        <div class="login-container">
            <div class="login-box">
                ...
                <div class="login-tabs">
                    ...
                    <button class="tablinks" onclick="openLoginType(event, 'StaffLogin')">Staff Login</button>
                ...
                <!-- Thêm form Staff Login -->
                <div id="StaffLogin" class="tabcontent">
                    <h3>Staff Login</h3>
                    <form action="MainController" method="POST">
                        Staff ID: <input type="text" name="staffID" value="<%= savedStaffUsername%>"/><br/>
                        Password: <input type="password" name="password" value="<%= savedStaffPassword%>"/><br/>
                        <div class="remember-me">
                            <label>
                                <input type="checkbox" name="rememberMe" id="staffRememberMe"
                                       <%= (savedStaffUsername != "" && savedStaffPassword != "") ? "checked" : ""%>>
                                <span>Ghi nhớ đăng nhập</span>
                            </label>
                        </div>
                ...
                <form action="MainController" method="POST">
                    ...
                    <div class="register-section">
                        ...
                        <a href="createUser.jsp" class="register-button">
