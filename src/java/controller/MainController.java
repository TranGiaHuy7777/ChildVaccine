...
public class MainController extends HttpServlet {
    ...
    private static final String STAFF_LOGIN = "StaffLogin";
    private static final String STAFF_LOGIN_CONTROLLER = "StaffLoginController";
    private static final String UPDATE_PAYMENT_STATUS = "UpdatePaymentStatus";
    private static final String UPDATE_PAYMENT_STATUS_CONTROLLER = "UpdatePaymentStatusController";
            ...
            if (action == null) {
                ...
                switch (action) {
                    ...
                    case DOCTOR_LOGIN:
                        ...
                        break;
                    case STAFF_LOGIN:
                        url = STAFF_LOGIN_CONTROLLER;
                        break;
                    case UPDATE_PAYMENT_STATUS:
                        url = UPDATE_PAYMENT_STATUS_CONTROLLER;
                        break;
